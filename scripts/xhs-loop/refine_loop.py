...
LANE_SPEC = {
    "搜索流": {
        ...
        "rules": """- 标题：关键词放最左（保搜索命中）+ 后半段带 ≥1 项张力，≤20 字。
  张力 6 选 1：对比反差 / 具体数字 / 悬念 / 冲突 / 时间承诺 / 结果承诺。
  ⛔ 首选标题不许是纯搜索词复读 —— 「第三轮hr面试一般会问什么」这种零增量的不行，
  「第三轮hr面试问什么，收尾三句最卡人」才行（数字+冲突）。
  **不要留悬念**（结论前置是对的），但「不留悬念」≠「只写关键词」。
